...
LC_19 <- rast("C:/Users/lfink/Desktop/eeflux/NLCD/NLCD_nYlVEgAiysZs27Lh21Mw/NLCD_2019_Land_Cover_L48_20210604_nYlVEgAiysZs27Lh21Mw.tiff")
...
LC_16 <- rast("C:/Users/lfink/Desktop/eeflux/NLCD/NLCD_nYlVEgAiysZs27Lh21Mw/NLCD_2016_Land_Cover_L48_20210604_nYlVEgAiysZs27Lh21Mw.tiff")
...
LC_13 <- rast("C:/Users/lfink/Desktop/eeflux/NLCD/NLCD_nYlVEgAiysZs27Lh21Mw/NLCD_2013_Land_Cover_L48_20210604_nYlVEgAiysZs27Lh21Mw.tiff")
...
Calculated for 2013. Combines all urban land cover classes and adds them to dataframe.
Your job is to calculate for 2016, 2019 and bind to the big table calculated above.
Please calculate percentage and sqkm (need to do 2013 sqkm)
...
Make sure each color corresponds to the right field:
 - Ag: blue
 - Urban: red
 - Total forest: green
 
Show all years' data on a single plot. Once the legend is correct, remove the x-axis titles. 
...
lc_all_years_lng <- lc_all_years |> 
  pivot_longer(cols = c(urban_sqkm13, ag_sqkm13, mixed13_sqkm), 
               names_to = "LCType", 
               values_to = "Area") 
