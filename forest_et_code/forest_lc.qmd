...
decid_transition <- lc_long %>% filter(LandCover == "decid")

mixed_transition <- lc_long %>% filter(LandCover == "mixed")

urban_transition <- lc_long %>% filter(LandCover == "urban")

ag_transition <- lc_long %>% filter(LandCover == "ag")


transition_matrix_eg <- table(eg_transition$sqkm, eg_transition$next_sqkm)
transition_matrix_decid <- table(decid_transition$sqkm, decid_transition$next_sqkm)
transition_matrix_mixed <- table(mixed_transition$sqkm, mixed_transition$next_sqkm)
transition_matrix_urban <- table(urban_transition$sqkm, urban_transition$next_sqkm)
transition_matrix_ag <- table(ag_transition$sqkm, ag_transition$next_sqkm)
